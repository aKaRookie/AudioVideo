...
class MyFragmentActivity : BaseActivity() {
    ...
    fun intFragment() {
        supportFragmentManager.beginTransaction().add(R.id.fl_1,AFragment.newInstance(), AFragment.TAG)
            .commit()
        supportFragmentManager.beginTransaction().add(R.id.fl_2,BFragment.newInstance(), BFragment.TAG)
            .commit()
    }
